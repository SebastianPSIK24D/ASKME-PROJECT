<x-app-layout title="Halaman Utama">
    <div class="py-3 bg-green-100">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-20 mr-8 ml-8 space-y-1 bg-green-100">
            <div class="card-base">
                <div class="card-body">
            ...
            <div class="card-base">
                <div class="card-body ">
                    <h3 class="text-subheading text-2xl font-extrabold">{{ __('Daftar Pertanyaan Terbaru') }}</h3>
                    @forelse ($questions as $question)
                        <div class="bg-white rounded-xl shadow-sm border border-2 border-green-600 overflow-hidden hover:shadow-md transition-shadow duration-300 mt-4 mb-4 mr-8 ml-8">
                                    ...
                                    <div class="flex-shrink-0 mr-3">
                                        ...
                                        @else
                                            <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden border border-gray-300">
                                                <svg class="w-9 h-9 text-gray-400 mt-1" fill="currentColor" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" /></svg>
                                            </div>
                                        @endif
                                    </div>
                                    <div>
                    ...
                    @empty
                        <div class="text-center py-16 bg-white rounded-xl border-2 border-dashed border-gray-300">
                            ...
                            <p class="text-gray-500 mt-1">Jadilah yang pertama bertanya di komunitas ini!</p>
                        </div>
                    @endforelse
                    <div class="mt-6">
